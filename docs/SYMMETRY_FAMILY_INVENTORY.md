...
| 16 | MotherSoftYParityOnePurity | YParity (term-level Z₂) | mother sector Klein (0,0) soft pairs under any single-letter dephase channel are y_par=1 pure; closed-form via Klein (0,0) same-parity constraint + F107 per-dephase truly criteria + (open F108 Part 1: Π²-even ⟹ soft) | Tier1Derived modulo Step 5; F109. Sister to F107 on the y_par axis; together they pin the y_par signature of truly + mother-soft cells. Explains the y_par=0 mother-soft count of zero observed empirically across F103/F105/F106 (1026 mother-soft classifications) | `MotherSoftYParityOnePurity` (added 2026-05-24) |
