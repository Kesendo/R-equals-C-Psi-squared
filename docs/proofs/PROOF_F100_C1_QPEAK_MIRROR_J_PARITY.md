...
**The empirical signature confirms it.** The witness [`_f71_nonuniform_j_verification.py`](../../simulations/_f71_nonuniform_j_verification.py) measured κ_b across N=3, 4, 5 and four palindromic J_sym profiles. κ shows no bond-position law, no J_sym law, no closed-form N-law, sign changes between J_sym magnitudes, and a relative J_sym-spread that reaches 143% at N=5 (76% / 62% / 143% at N=3 / 4 / 5). That is the signature of a structureless residue, not of a function awaiting its formula.
