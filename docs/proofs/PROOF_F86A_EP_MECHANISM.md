...
**Separate genuine EP (Σγ=0):** [The Fragile Bridge](../../hypotheses/FRAGILE_BRIDGE.md) (chiral symmetry breaking at the real parameter γ_crit; K=403 is one finite-grid approach reading), a DISTINCT gain-loss system, not a "global instance" of the full block-L.
