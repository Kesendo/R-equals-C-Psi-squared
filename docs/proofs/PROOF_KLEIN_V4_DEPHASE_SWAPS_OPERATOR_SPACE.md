...
- **F108 cross-dephasing (closed positively by Welle 14, with mechanism distinction).** F108 Parts 1, 2, 3 (Pi5bilinear under Z-, X-, Y-dephasing respectively) ARE Klein-V₄ equivalent, but via two DIFFERENT mechanisms (proven in [PROOF_F108_KLEIN_V4_EQUIVALENCE.md](PROOF_F108_KLEIN_V4_EQUIVALENCE.md), Welle 14):
