...
| interior-core death (p_c,p_c)→(p_c+1,p_c+1): ‖Wx₁‖ | 1.7e-15 (N=5, core (3,3)), 3.2e-15 (N=7, core (4,4)) | the spin-½ core is N-robust across the odd N tested (item 7) |
...
3. Gap byte-identity across sectors: observed, not implied by the intertwiner (observed byte-identical at N=5 and now N=7, where the (4,4) core's near-defective gap equals the (1,2) seed gap, 2.506e-03, to the digit).
