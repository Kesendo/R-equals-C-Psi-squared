# The R₉₀ frozen divisor: mirror-balanced dephasing profiles that pin an eigenvalue for every coupling
...
At the fully degenerate point of the locus, δ = 0 (uniform dephasing), X = J·K and the cofactor collapses to a J-monomial:
