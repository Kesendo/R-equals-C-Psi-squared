...
**Builds on:** F112 ([F112](PROOF_F112_LINDBLAD_BIT_B_PI_BALANCE.md)), F113 empirical anchor ([F113 break-magnitude formula](../../experiments/F113_BREAK_MAGNITUDE_FORMULA.md))
...
- **F112 non-Hermitian extension** ([F112 non-Hermitian extension](PROOF_F112_NONHERMITIAN_UNIVERSAL_N.md), Tier1Derived universal-N via Welle 11): closes the commutator-superoperator balance ‖L_{H,+i}‖² = ‖L_{H,-i}‖² for any H. It concerns the commutator −i[H,·], **not** the dissipator self-term; the T1-self-term ‖L_{T1,+i}‖² = ‖L_{T1,-i}‖² is closed general-N by this proof's own single-site shifted-support + tensor-factorization argument (the T1-self-term note in the reduction chain).
