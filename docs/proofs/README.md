...
| [Asymptotic Sector Projection](PROOF_ASYMPTOTIC_SECTOR_PROJECTION.md) | Under Heisenberg + local Z-dephasing at every site of any connected graph, the asymptotic state is a mixture of maximally-mixed excitation sectors weighted by the initial sector populations. Those populations are conserved on their own, needing neither condition. | (independent) |
