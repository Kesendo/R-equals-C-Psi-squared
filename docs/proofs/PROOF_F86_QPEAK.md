...
| **F86b₄**      | Dicke-K 3/8 anchor via X⊗N-eigenbasis (2026-05-18)                     | Tier 1 derived                    | [`docs/water/README.md`](../water/README.md) + `f86b_dicke_pi2odd_closed_form.py` |
...
| **F86d**       | Endpoint orbit Q ≈ 2.5 (9 (c, N) combos, 2.39–2.61, ~2% variation)      | Tier 2 promotion candidate        | `PerF71OrbitObservation.cs`                                              |
