...
|---------|-----------|------|-------|
| **F86a** EP mechanism | Q_EP = 2/g_eff, t_peak = 1/(4γ₀); genuine EP of the toy 2-level rate-channel reduction | Tier 1 derived (EP location, t_peak). Full block: non-normal on the real Q axis; finite-q Puiseux-1/2 defective EP2 seeds certified at N=5,7,9. All odd N: nullity-surplus count only; literal drop and genericity open beyond the certified sizes. Off-axis complex-Q EP open (`LocalGlobalEpLink`; see [§The real-axis EP](PROOF_F86A_EP_MECHANISM.md)) | [F86a EP mechanism](PROOF_F86A_EP_MECHANISM.md) |
