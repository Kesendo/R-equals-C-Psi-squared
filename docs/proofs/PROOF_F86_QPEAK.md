...
|---------|-----------|------|-------|
| **F86a** EP mechanism | Q_EP = 2/g_eff, t_peak = 1/(4γ₀); genuine EP of the toy 2-level rate-channel reduction | Tier 1 derived (EP location, t_peak); local-vs-global EP **retracted 2026-06-21 → OpenQuestion** (full block-L non-normal on the real Q axis; the "no real-axis coalescence" part corrected 2026-07-07, a real-axis defective seed IS there per F89 (transition proven ∀ odd N, defective through the N=11 census), see [§Correction](PROOF_F86A_EP_MECHANISM.md)) | [PROOF_F86A_EP_MECHANISM](PROOF_F86A_EP_MECHANISM.md) |
...
|----------------|------------------------------------------------------------------------|-----------------------------------|--------------------------------------------------------------------------|
| **F86a**       | EP mechanism (t_peak, Q_EP, dressed pair, AIII chiral, L_eff mirror)    | Tier 1 derived                    | [PROOF_F86A_EP_MECHANISM](PROOF_F86A_EP_MECHANISM.md)                    |
| **F86b₁**      | Bare 2×2 K_b closed forms; x_peak = 2.196910, ratio = 0.671535          | Tier 1 derived                    | `C2BareDoubledPtfClosedForm.cs`                                          |
| **F86b₂**      | Sub-class lift HWHM_ratio = 0.671535 + α·g_eff + β                      | Tier 1 candidate (analytical blocked) | `F86HwhmClosedFormClaim.cs` + [PROOF_F86B_UNIVERSAL_SHAPE](PROOF_F86B_UNIVERSAL_SHAPE.md) |
| **F86b₃**      | Universal shape: Interior 0.756, Endpoint 0.770                         | Tier 1 candidate                  | `UniversalShapePrediction.cs` + [PROOF_F86B_UNIVERSAL_SHAPE](PROOF_F86B_UNIVERSAL_SHAPE.md) |
| **F86b₄**      | Dicke-K 3/8 anchor via X⊗N-eigenbasis (2026-05-17)                     | Tier 1 derived                    | `DickeAnchor.cs` (canonical typed home) + [PROOF_F86B_UNIVERSAL_SHAPE](PROOF_F86B_UNIVERSAL_SHAPE.md) + `f86b_dicke_pi2odd_closed_form.py` + [`docs/water/README.md`](../water/README.md) |
| **F86b₅**      | Polarity-pair Q_peak ∈ {1.5, 2.5} = 2 ± 1/2 (schema)                    | Tier 1 schema                     | `PolarityPairQPeakDecompositionClaim.cs`                                 |
| **F86c**       | F71 spatial mirror Q_peak(b) = Q_peak(N−2−b)                            | Tier 1 derived                    | [PROOF_F86C_F71_MIRROR](PROOF_F86C_F71_MIRROR.md)                        |
...
| **F86_block**  | g_eff(c, N, b) closed-form blocked, six routes L1–L6 proven             | Negative Tier 1 (structural)      | [PROOF_F86B_OBSTRUCTION](PROOF_F86B_OBSTRUCTION.md)                      |
...
**Separate genuine EP (Σγ=0 gain-loss):** [FRAGILE_BRIDGE](../../hypotheses/FRAGILE_BRIDGE.md) (Hopf bifurcation = chiral symmetry breaking, Petermann K=403 in the complex γ plane), a DISTINCT gain-loss system, not a "global instance" of the full block-L (the local-vs-global EP connection was retracted 2026-06-21; the full Σγ=N·γ₀ block is genuinely non-normal on the real Q axis but has no real-axis coalescence). *(The "no real-axis coalescence" clause was corrected 2026-07-07: a real-axis defective seed IS there at every odd N, F89, census-defective through N=11; the retraction's grid missed a √-EP window ~20-30× narrower than its step. See [PROOF_F86A_EP_MECHANISM](PROOF_F86A_EP_MECHANISM.md), the Correction section.)*
