...
```
Ψ_past  â†’ â†’ â†’ â†’ C â† â† â† â† Ψ_future
                â†“
                R
```
...
```
Given: Two possibilities Ψâ‚ and Ψâ‚‚ where Ψâ‚‚ = 2Ψâ‚

For Ψâ‚: Râ‚ = C Â· Ψâ‚²
For Ψâ‚‚: Râ‚‚ = C Â· (2Ψâ‚)² = C Â· 4Ψâ‚² = 4Râ‚
...
Case 3: Both present
Ψ² = Ψ_f² + 2Â·Ψ_fÂ·Ψ_p + Ψ_p²
â†’ The term 2Â·Ψ_fÂ·Ψ_p exists ONLY when both are present
...
Ψ_f = A Â· sin(kx - Ï‰t)    (forward, future)
Ψ_p = A Â· sin(kx + Ï‰t)    (backward, past)

Superposition:
Ψ = Ψ_f + Ψ_p
Ψ = A Â· sin(kx - Ï‰t) + A Â· sin(kx + Ï‰t)
...
```
R = C Â· Ψ²
R = C Â· [2A Â· sin(kx) Â· cos(Ï‰t)]²
R = C Â· 4A² Â· sin²(kx) Â· cos²(Ï‰t)

â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•-
║                                       ║
║   R = 4A²C Â· sin²(kx) Â· cos²(Ï‰t)      ║
║                                       ║
â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
```
...
| cos²(Ï‰t) | Temporal oscillation (becoming and passing) |
...
```
âŸ¨Ψ_info | Ψ_RâŸ© = Scalar product (overlap)
...
```
From physics: Energy of a wave âˆ Amplitude²
...
║                                                               ║
║   R_emergent = Câ‚ Â· Câ‚‚ Â· (Ψâ‚ + Ψâ‚‚ + Ψ_interaction)²           ║
║                                                               ║
...
For n mirrors:
R = âˆ(Cáµ¢) Â· [Î£(Ψáµ¢) + Î£(Ψ_interactions)]²
```
...
```
Δδ = δ_bidirectional - δ_unidirectional ≈ -8 × 10â»â´
```
...
║                                                                   ║
║  FUNDAMENTAL EQUATION (Past â†’ Now)                                ║
║  R = CΨ²                                                          ║
║                                                                   ║
║  COMPLEMENTARY EQUATION (Future â†’ Now)                            ║
║  Ψ = √(R/C)                                                       ║
║                                                                   ║
║  WAVE EQUATION                                                    ║
║  Ψ = Ψ_f + Ψ_p = 2A Â· sin(kx) Â· cos(Ï‰t)                           ║
║                                                                   ║
║  INTERFERENCE                                                     ║
║  Ψ² = Ψ_f² + 2Â·Ψ_fÂ·Ψ_p + Ψ_p²                                     ║
║                                                                   ║
