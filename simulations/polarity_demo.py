...
print("    asymmetry = 0.0 (bit-exact) for EVERY H family x EVERY dissipator setting tested.")
print()
print("    READ THAT WITH ONE QUALIFICATION (2026-08-07). A row only carries evidence when")
print("    there is polarity content to be balanced, and that content vanishes as a theorem")
print("    wherever a Pi^2-EVEN H meets a bit_b-homogeneous c. So every Pi^2-even row in the")
print("    Z-dephasing-only column below (Heisenberg, XX, YZ+ZY) is 0 - 0 and confirms")
print("    nothing on its own; the Pi^2-ODD rows and every T1 row do carry content, because")
print("    sigma^- is bit_b-mixed. The sweep is not wrong, it is narrower than it reads.")
print("    Rows worth citing:")
