...
print("artifact; the −2γ band's max|Im|=E1 is γ-independent AT THE N THIS SCRIPT SWEEPS (N>=4 here,")
print("N>=3 in the proof). It is NOT γ-independent at N=2, where the {0,2} pair overtakes E1 above")
print("Q=2/sqrt(3): PROOF_CHAIN_GAP_DOMINANCE section 4.2. DONE.")
