...
Usage:
  python simulations/zn_mirror_hardware_analysis.py path/to/zn_mirror_data.json
...
def main(json_path):
    ...
    print("Linear scalings from framework (see zn_mirror_hardware_prediction.py):")
