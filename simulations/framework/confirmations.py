...
class Confirmations:
    ...
    _ENTRIES = {
        ...
        'ibm_ep_onset_may2026': {
            ...
            'predicted_value': {
                'se_walk_handover_reading': 'SE-walk population handover: finite-time revival remains near the 1/N = 1/3 reference level through Q_label=1.5 and is larger at Q_label=2.5. This population observable does not locate a spectral transition; coalescence and Jordan character remain unmeasured.',
                'twirl_simulate_revival': '0.28 → 0.84 across the same Q scan (K=16 exact-statevector twirl validation)',
            ...
            'measured_value': {
                ...
                'high_Q_discrepancy': '0.703 measured vs 0.842 exact-twirl (raw 0.8417853730254796) at Q_label=20; consistent with accumulated circuit/gate cost, but the record contains no calibrated model assigning a unique cause',
            },
