...
class Confirmations:
    ...
    _ENTRIES = {
        ...
        'f95_angle_steering_kingston_may2026': {
            ...
            'framework_primitive': 'F95AngleAtQuadraticZeroPi2Inheritance (θ(c;b) = arctan(√(c/b² − 1)), finite b>0) + F25 Lindblad CΨ trajectory + complex CΨ_com signed-sum-of-off-diagonals extension',
