...
This is the companion to felt_time_amplitude_law.py. That (cheap, scalable) script establishes the
...
def density_gradient(N, prow, pcol, J, g, bnds):
    """grad^2(b) = (n(j)-n(j+1))^2 of the slow survivor density mode (see felt_time_amplitude_law)."""
...
def main():
    ...
    print(f"Q={Q}, dJ={dJ}, chain. Companion to felt_time_amplitude_law.py (the block-level law).\n",
          flush=True)
