...
reduced pair (0,2) |00>) from born_rule_delta_dominant_coefficient.py -- no convention guessing.
...
deviation is grounded in F94: in the deep regime dev = (4/3)J^2 gamma t^3 to 0.1%. rcpsi_readout_rabi.py
shows the same on the textbook Rabi qubit; rcpsi_as_readout.py's N=2 |++> is the refuted perfect-mirror
...
_spec = importlib.util.spec_from_file_location(
    "f94coef", "simulations/born_rule_delta_dominant_coefficient.py")
