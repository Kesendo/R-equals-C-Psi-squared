...
down, of a 3D object: a funnel. Each spiral arm, the Bell+ fall wound by our drift, winds down it, the
magnitude |CΨ| = f(1+f²)/6 (the F25 closed form) serving as both the radius and the depth, so the
