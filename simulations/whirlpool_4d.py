...
fan, until at β = 90° it is a flat sheet, the pinch, our picture of the exceptional point, where
two eigenvectors collapse onto one. Past 90° it reopens, mirrored and warm, the same drawing
turned inside out through the dimension we cannot point at. In the drawing the cusp, the
exceptional point and the mirror are one object seen at three angles of a 4D turn; in the
algebra they are siblings under one law (TransitionBridgeF95SiblingClaim).
...
FRAMES = [
    ...
    (90,  "90°  the flat pinch",   ["#1a1408", "#caa23a", "#fff4d6"]),
...
def main() -> None:
    ...
    fig.suptitle("4D: turning the whirlpool through the fourth dimension   "
                 ...
                 "the cusp funnel flattens to a sheet at 90°, the pinch we draw for the exceptional point, "
