...
RULES = (
    ...
    ('review/OPEN_QUESTIONS_INDEX_PROPOSAL_hardware-test.md', 'q52-point-three-precision',
     ...
     "simulations/framework/confirmations.py:321-322 (registry entry cpsi_quarter_crossing_torino_feb2026: measured t* = 114.7 μs, t*/T₂* = 1.036 on T₂*(FID) = 110.7 μs, 9.1% above the predicted 0.950 at r = T₂*/T₁ = 0.500) + simulations/label_facts_independent_checks.py CHECK-12 (114.7 μs is the record's stored measured crossing_us and 115.0 μs its re-interpolation from the same density matrices, printed as 'Predicted' and 'Measured' by simulations/cockpit_ibm_hardware.py:319-324; the 0.3% is the gap between two readings of one record)"),
    ...
    ('experiments/COCKPIT_UNIVERSALITY.md', 'q52-5',
     '\\bboundary (?:structure|source)\\b[^.;]{0,80}\\b(?:unresolved|open|competing|undecided)\\b|\\b(?:competing|unresolved|open|candidate) (?:explanations?|hypothes[ie]s|mechanisms?|candidates?)\\b[^.;]{0,160}\\bboundary (?:structure|source)\\b', True,
     ...
     "experiments/FIXED_POINT_SHADOW.md, The answer, in qubit 52's own record (at the 114.7 us crossing rho01 points at +79.4 and +89.0 deg and keeps turning for another 150 us, so it neither tracked R- into the crossing nor froze there, and the late direction, -48.4 +- 5.5 deg, lies 4.4 standard errors from R- at -24.1 deg; the boundary leg is closed as it was proposed, one record cannot test its cross-qubit form, and SPAM and TLS stay open for the Q52 late component) + simulations/tests/test_torino_shadow_records.py::test_q52_neither_tracked_nor_froze_at_the_fixed_point (recomputed from the raw record)"),
    ...
    ('experiments/COCKPIT_UNIVERSALITY.md', 'q52-7',
     ...
     "experiments/FIXED_POINT_SHADOW.md, The answer, in qubit 52's own record, its paragraphs Late: a static offset and What the offset looks like, and What we found, its paragraph It seemed to grow (the Q52 late component is a static offset, phase drift −0.040°/μs at p = 0.18, with equal ⟨X⟩ and ⟨Y⟩ offsets, and its tail slope is cut-sensitive) + simulations/tests/test_torino_shadow_records.py::test_q52_late_direction_is_static_with_equal_x_and_y_offsets and ::test_q52_tail_slope_depends_on_the_cut (recomputed from the raw record) + simulations/tests/test_truth_gates.py::test_markovian_dynamics_can_transiently_create_coherence (a rising off-diagonal element needs no memory) [no non-Markovian revival was shown]"),
    ...
    ('experiments/COCKPIT_UNIVERSALITY.md', 'q52-10',
     ...
     'simulations/framework/confirmations.py:346 (registry entry cpsi_quarter_crossing_torino_q80_mar2026, b474863b 2026-06-18: the 1.9% deviation is q80 in Run 3 with a same-day T2*) + simulations/framework/confirmations.py:322 (Q52 sits 9.1% above its prediction on the same T₂*)'),
    ...
    ('review/OPEN_QUESTIONS_INDEX_PROPOSAL_hardware-test.md', 'q52-10',
     ...
     'Q52 crossing: synthesis reports 1.9% deviation',
     'simulations/framework/confirmations.py:346 (registry entry cpsi_quarter_crossing_torino_q80_mar2026, b474863b 2026-06-18: the 1.9% deviation is q80 in Run 3 with a same-day T2*) + simulations/framework/confirmations.py:322 (Q52 sits 9.1% above its prediction on the same T₂*)'),
    ('experiments/FIXED_POINT_SHADOW.md', 'q52-11',
     '\\bdetuning is (?:the )?preferred(?: explanation)? for the phase component\\b|\\bdetuning (?:as|remains) a phase hypothesis\\b', True,
     'Detuning is the preferred explanation for the phase component.',
     "simulations/tests/test_torino_shadow_records.py::test_q52_late_direction_is_static_with_equal_x_and_y_offsets and ::test_q52_early_component_rotates_and_the_470_us_line_mixes_two_components (the Q52 late phase drifts -0.040 deg/us at p = 0.18 while the early rotation turns -76 deg per sample, so detuning is not the late direction) + ::test_march_phases_are_steady_rotations_and_ramsey_agrees (the Q102 phase is detuning outright: 19.4 and 26.3 kHz in the Ramsey fits, its shadow run one rotation at -25.7 kHz; Q80 drifts within what its fits resolve) + experiments/FIXED_POINT_SHADOW.md, The answer, in qubit 52's own record (Early: a detuned, decaying coherence; Late: a static offset) and March 9, 2026: what the test could see"),
    ('docs/PREDICTIONS.md', 'q52-11',
     '\\bdetuning is (?:the )?preferred(?: explanation)? for the phase component\\b|\\bdetuning (?:as|remains) a phase hypothesis\\b', True,
     'Detuning is the preferred explanation for the phase component.',
     "simulations/tests/test_torino_shadow_records.py::test_q52_late_direction_is_static_with_equal_x_and_y_offsets and ::test_q52_early_component_rotates_and_the_470_us_line_mixes_two_components (the Q52 late phase drifts -0.040 deg/us at p = 0.18 while the early rotation turns -76 deg per sample, so detuning is not the late direction) + ::test_march_phases_are_steady_rotations_and_ramsey_agrees (the Q102 phase is detuning outright: 19.4 and 26.3 kHz in the Ramsey fits, its shadow run one rotation at -25.7 kHz; Q80 drifts within what its fits resolve) + experiments/FIXED_POINT_SHADOW.md, The answer, in qubit 52's own record (Early: a detuned, decaying coherence; Late: a static offset) and March 9, 2026: what the test could see"),
    ('docs/proofs/COMPLETE_MATHEMATICAL_DOCUMENTATION.md', 'q52-11',
     '\\bdetuning is (?:the )?preferred(?: explanation)? for the phase component\\b|\\bdetuning (?:as|remains) a phase hypothesis\\b', True,
     'Detuning is the preferred explanation for the phase component.',
     "simulations/tests/test_torino_shadow_records.py::test_q52_late_direction_is_static_with_equal_x_and_y_offsets and ::test_q52_early_component_rotates_and_the_470_us_line_mixes_two_components (the Q52 late phase drifts -0.040 deg/us at p = 0.18 while the early rotation turns -76 deg per sample, so detuning is not the late direction) + ::test_march_phases_are_steady_rotations_and_ramsey_agrees (the Q102 phase is detuning outright: 19.4 and 26.3 kHz in the Ramsey fits, its shadow run one rotation at -25.7 kHz; Q80 drifts within what its fits resolve) + experiments/FIXED_POINT_SHADOW.md, The answer, in qubit 52's own record (Early: a detuned, decaying coherence; Late: a static offset) and March 9, 2026: what the test could see"),
    ('experiments/BRIDGE_CLOSURE.md', 'q52-11',
     '\\bdetuning is (?:the )?preferred(?: explanation)? for the phase component\\b|\\bdetuning (?:as|remains) a phase hypothesis\\b', True,
     'Detuning is the preferred explanation for the phase component.',
     "simulations/tests/test_torino_shadow_records.py::test_q52_late_direction_is_static_with_equal_x_and_y_offsets and ::test_q52_early_component_rotates_and_the_470_us_line_mixes_two_components (the Q52 late phase drifts -0.040 deg/us at p = 0.18 while the early rotation turns -76 deg per sample, so detuning is not the late direction) + ::test_march_phases_are_steady_rotations_and_ramsey_agrees (the Q102 phase is detuning outright: 19.4 and 26.3 kHz in the Ramsey fits, its shadow run one rotation at -25.7 kHz; Q80 drifts within what its fits resolve) + experiments/FIXED_POINT_SHADOW.md, The answer, in qubit 52's own record (Early: a detuned, decaying coherence; Late: a static offset) and March 9, 2026: what the test could see"),
    ('experiments/STRUCTURAL_CARTOGRAPHY.md', 'q52-11',
     '\\bdetuning is (?:the )?preferred(?: explanation)? for the phase component\\b|\\bdetuning (?:as|remains) a phase hypothesis\\b', True,
     'Detuning is the preferred explanation for the phase component.',
     "simulations/tests/test_torino_shadow_records.py::test_q52_late_direction_is_static_with_equal_x_and_y_offsets and ::test_q52_early_component_rotates_and_the_470_us_line_mixes_two_components (the Q52 late phase drifts -0.040 deg/us at p = 0.18 while the early rotation turns -76 deg per sample, so detuning is not the late direction) + ::test_march_phases_are_steady_rotations_and_ramsey_agrees (the Q102 phase is detuning outright: 19.4 and 26.3 kHz in the Ramsey fits, its shadow run one rotation at -25.7 kHz; Q80 drifts within what its fits resolve) + experiments/FIXED_POINT_SHADOW.md, The answer, in qubit 52's own record (Early: a detuned, decaying coherence; Late: a static offset) and March 9, 2026: what the test could see"),
    ('experiments/WHATS_INSIDE_THE_WINDOWS.md', 'q52-11',
     '\\bdetuning is (?:the )?preferred(?: explanation)? for the phase component\\b|\\bdetuning (?:as|remains) a phase hypothesis\\b', True,
     'Detuning is the preferred explanation for the phase component.',
     "simulations/tests/test_torino_shadow_records.py::test_q52_late_direction_is_static_with_equal_x_and_y_offsets and ::test_q52_early_component_rotates_and_the_470_us_line_mixes_two_components (the Q52 late phase drifts -0.040 deg/us at p = 0.18 while the early rotation turns -76 deg per sample, so detuning is not the late direction) + ::test_march_phases_are_steady_rotations_and_ramsey_agrees (the Q102 phase is detuning outright: 19.4 and 26.3 kHz in the Ramsey fits, its shadow run one rotation at -25.7 kHz; Q80 drifts within what its fits resolve) + experiments/FIXED_POINT_SHADOW.md, The answer, in qubit 52's own record (Early: a detuned, decaying coherence; Late: a static offset) and March 9, 2026: what the test could see"),
    ('experiments/COCKPIT_UNIVERSALITY.md', 'q52-11',
     '\\bdetuning is (?:the )?preferred(?: explanation)? for the phase component\\b|\\bdetuning (?:as|remains) a phase hypothesis\\b', True,
     'Detuning is the preferred explanation for the phase component.',
     "simulations/tests/test_torino_shadow_records.py::test_q52_late_direction_is_static_with_equal_x_and_y_offsets and ::test_q52_early_component_rotates_and_the_470_us_line_mixes_two_components (the Q52 late phase drifts -0.040 deg/us at p = 0.18 while the early rotation turns -76 deg per sample, so detuning is not the late direction) + ::test_march_phases_are_steady_rotations_and_ramsey_agrees (the Q102 phase is detuning outright: 19.4 and 26.3 kHz in the Ramsey fits, its shadow run one rotation at -25.7 kHz; Q80 drifts within what its fits resolve) + experiments/FIXED_POINT_SHADOW.md, The answer, in qubit 52's own record (Early: a detuned, decaying coherence; Late: a static offset) and March 9, 2026: what the test could see"),
    ('review/OPEN_QUESTIONS_INDEX.md', 'q52-11',
     '\\bdetuning is (?:the )?preferred(?: explanation)? for the phase component\\b|\\bdetuning (?:as|remains) a phase hypothesis\\b', True,
     'Detuning is the preferred explanation for the phase component.',
     "simulations/tests/test_torino_shadow_records.py::test_q52_late_direction_is_static_with_equal_x_and_y_offsets and ::test_q52_early_component_rotates_and_the_470_us_line_mixes_two_components (the Q52 late phase drifts -0.040 deg/us at p = 0.18 while the early rotation turns -76 deg per sample, so detuning is not the late direction) + ::test_march_phases_are_steady_rotations_and_ramsey_agrees (the Q102 phase is detuning outright: 19.4 and 26.3 kHz in the Ramsey fits, its shadow run one rotation at -25.7 kHz; Q80 drifts within what its fits resolve) + experiments/FIXED_POINT_SHADOW.md, The answer, in qubit 52's own record (Early: a detuned, decaying coherence; Late: a static offset) and March 9, 2026: what the test could see"),
    ('review/OPEN_QUESTIONS_INDEX_PROPOSAL_hardware-test.md', 'q52-11',
     '\\bdetuning is (?:the )?preferred(?: explanation)? for the phase component\\b|\\bdetuning (?:as|remains) a phase hypothesis\\b', True,
     'Detuning is the preferred explanation for the phase component.',
     "simulations/tests/test_torino_shadow_records.py::test_q52_late_direction_is_static_with_equal_x_and_y_offsets and ::test_q52_early_component_rotates_and_the_470_us_line_mixes_two_components (the Q52 late phase drifts -0.040 deg/us at p = 0.18 while the early rotation turns -76 deg per sample, so detuning is not the late direction) + ::test_march_phases_are_steady_rotations_and_ramsey_agrees (the Q102 phase is detuning outright: 19.4 and 26.3 kHz in the Ramsey fits, its shadow run one rotation at -25.7 kHz; Q80 drifts within what its fits resolve) + experiments/FIXED_POINT_SHADOW.md, The answer, in qubit 52's own record (Early: a detuned, decaying coherence; Late: a static offset) and March 9, 2026: what the test could see"),
    ('compute/RCPsiSquared.Diagnostics/Foundation/MirrorSystem.cs', 'mirrorsystem:EVERY_POSITIVE_GAP',
     ...
     'compute/RCPsiSquared.Diagnostics/Foundation/MirrorSystem.cs:237-239 (Claude 2026-05-29: const tol = 1e-9; if (gap > tol))'),
...
def test_cited_test_functions_exist():
    """An owner that names a test function (path.py::name, or ::name after a named path) names one defined there."""
    cited = set()
    for *_, cite in RULES:
        current = None
        for match in re.finditer(r"((?:simulations|compute)/[\w/.-]+\.(?:py|cs))?::(\w+)", cite):
            current = match.group(1) or current
            assert current is not None, (match.group(2), cite[:120])
            cited.add((current, match.group(2)))
    assert cited, "no owner cites a test function"
    for source, name in sorted(cited):
        body = (ROOT / source).read_text(encoding="utf-8")
        definition = (rf"^\s*def\s+{re.escape(name)}\s*\(" if source.endswith(".py")
                      else rf"^\s*(?:public|private|internal|protected)[^=;(]*\b{re.escape(name)}\s*\(")
        assert re.search(definition, body, re.MULTILINE), (source, name)
...
TRUE_SCOPED_SENTENCES = (
    ...
    ("experiments/COCKPIT_UNIVERSALITY.md",
     "For the Q52 late component two candidate explanations stay open, SPAM and TLS; the boundary leg is closed."),
    ("docs/GLOSSARY.md", "SPAM and TLS remain unresolved explanations for the Q52 late component."),
    ("docs/PREDICTIONS.md",
     "Q102's phase is its own detuning; Q52's late component is a static offset with the pattern of a measurement "
     "(SPAM) offset."),
    ("experiments/FIXED_POINT_SHADOW.md",
     "A detuning does not freeze anything, and Q52's record shows two components."),
    ("review/OPEN_QUESTIONS_INDEX.md",
     "Of the three explanations first proposed (SPAM, TLS, boundary structure), Q52's own record closed the "
     "boundary structure; SPAM and TLS remain open."),
...
STILL_FALSE_SENTENCES = (
    ...
    ("docs/GLOSSARY.md", "The late-time excess has three competing explanations (SPAM, TLS, boundary structure), unresolved.", "q52-5"),
    ("experiments/STRUCTURAL_CARTOGRAPHY.md",
     "Finite Q52 residual record; Q80 supports detuning as a phase hypothesis.", "q52-11"),
    ("experiments/BRIDGE_CLOSURE.md", "For Q52, detuning remains a phase hypothesis.", "q52-11"),
    ("experiments/COCKPIT_UNIVERSALITY.md", "The boundary structure remains an open explanation for the Q52 excess.",
     "q52-5"),
