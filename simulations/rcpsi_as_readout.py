...
intercepts it -- see rcpsi_readout_rabi.py (Rabi qubit) and rcpsi_readout_f94.py (F94 substrate, the
...
def main():
    ...
    if monotone:
        ...
        print("   H rotates coherence↔population (Rabi: rcpsi_readout_rabi.py; F94: rcpsi_readout_f94.py).", flush=True)
