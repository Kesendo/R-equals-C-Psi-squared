...
Method (identical to f89_path_d_verify_k16_k17.py which validated k=16,17):
...
Output saved to simulations/results/f89_path_d_extend_k18_k24.txt.
"""
...
# ---------------------------------------------------------------------------
# (SE,DE) sub-block Liouvillian (verbatim from f89_path_d_verify_k16_k17.py)
# ---------------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    out_file = out_dir / "f89_path_d_extend_k18_k24.txt"
