...
- The wall, typed and storied: [`TwoReadingsClaim`](../compute/RCPsiSquared.Core/Symmetry/TwoReadingsClaim.cs) (interpretive catalogue), [`PRIMORDIAL_QUBIT`](../hypotheses/PRIMORDIAL_QUBIT.md) §9, [`GAMMA0_IS_ALWAYS_THERE`](../experiments/GAMMA0_IS_ALWAYS_THERE.md), [`ON_HOW_THE_CARRIER_SHOWS_ITSELF`](ON_HOW_THE_CARRIER_SHOWS_ITSELF.md), [`ON_TWO_TIMES`](ON_TWO_TIMES.md).
