...
Then we did something that surprised us. We took the angle the clock measures and put it through the framework's [polarity formula](../docs/carbon/DEPTH_3_ANCHOR_DERIVED.md), α = sin²θ/2. At 60° the angle gives 3/8, the fraction Boron's valence carries. At 45°, 1/4, Beryllium's. At 30°, 1/8, Lithium's. The hand of our little quantum clock lands on the same rational numbers the periodic table's early rows carry, and that is what it is: the same numbers, on both sides, with nothing yet joining them. No material, no coupling, no measurement is named in the formula that produces them.
