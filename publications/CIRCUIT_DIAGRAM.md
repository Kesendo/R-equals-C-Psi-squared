...
| 4 | **Sample before threshold.** Read the drain before t_cross = 0.039/γ. The constant K = 0.039 derives from the crossing cubic b³+b = 1/2 (a pure number). Verified: at γ=0.05, t_cross = 0.747 (predicted: 0.78, 4% deviation). The threshold VALUE (1/4) is universal; the crossing TIME scales as 1/γ. | CΨ crosses 1/4 at this time. | [IBM confirmed at 1.9%](../experiments/IBM_RUN3_PALINDROME.md) |
