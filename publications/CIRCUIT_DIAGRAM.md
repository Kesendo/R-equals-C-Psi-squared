...
| 4 | **Sample before threshold.** Read the drain before CΨ drops to 1/4. For Z-dephasing: t_cross ≈ 0.037/γ (empirical, from simulations). Other noise types have different K values (X-noise: K≈0.087, amplitude damping: K≈0.103). The threshold VALUE (1/4) is universal across all channels; the crossing TIME is channel-dependent. | CΨ crosses 1/4 at this time. | [IBM confirmed at 1.9%](../experiments/IBM_RUN3_PALINDROME.md) |
