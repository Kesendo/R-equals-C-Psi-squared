...
([Mirror Symmetry Proof](../docs/MIRROR_SYMMETRY_PROOF.md)) is not limited
...
([Mirror Symmetry Proof](../docs/MIRROR_SYMMETRY_PROOF.md)) established this
...
| Compatible via non-local Π | 2/36 | Not factorizable, entangled |
...
**Physical reason:** H = XZ + YZ mixes X and Y on one site coupled to Z on
the other. The time reversal for this combination requires correlating both
sites jointly. A per-site mirror cannot reflect an intrinsically two-site
property.
...
The **Incompleteness Proof** ([INCOMPLETENESS_PROOF](../docs/INCOMPLETENESS_PROOF.md))
...
- [Mirror Symmetry Proof](../docs/MIRROR_SYMMETRY_PROOF.md): the original palindrome theorem (Heisenberg)
...
- [Incompleteness Proof](../docs/INCOMPLETENESS_PROOF.md): universality strengthens the external-noise argument
