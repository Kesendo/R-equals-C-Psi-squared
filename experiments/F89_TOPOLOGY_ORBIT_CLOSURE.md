...
#### Path-3 octic EP location (Tier 1 derived)
...
- F89 → F86 bridge: deferred. Path-3's octic EP at q ≈ 0.659 has merged eigenvalue Re(λ_EP) = −4γ which numerically matches F86's reported t_peak = 1/(4γ₀); whether this is a structural inheritance or an algebraic AT-rate-midpoint coincidence requires F86 itself to be on settled foundations first. Cross-framework bridge claims to be revisited after F86 is restarted with a clean slate.
