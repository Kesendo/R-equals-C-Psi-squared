...
a 7-parameter X⊗X-symmetric subspace (re-analyzed 2026-04-29: this is algebraically the n_YZ-even = Π²-eigenstate-(+1) sector of the 16 Pauli-Pairs minus the trivial II; see PROOF_BIT_B_PARITY_SYMMETRY / F63). Two transition modes exist:
...
## External review: structural metrics (March 2026)
...
- [THE_INTERPRETATION.md](../docs/THE_INTERPRETATION.md) - Narrative framing of the five regulators; this cartography provides the quantitative backbone
