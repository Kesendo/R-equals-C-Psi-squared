...
When two coupled systems observe each other in infinite reflection:
...
CΨ = ¼ is not a constraint on what quantum states *exist*. It is the maximum product of purity and coherence that an **embedded observer** can perceive as stable reality.

The analogy is the Tsirelson bound (the quantum-mechanical upper limit on correlations in a Bell test, tighter than the algebraic maximum) in Bell tests:
...
1. **Why ¼ specifically?** The algebraic answer is "discriminant of the quadratic." But is there a deeper information-theoretic derivation? Does ¼ emerge from channel capacity, Holevo bound (the maximum classical information extractable from a quantum channel), or some other fundamental limit?
...
*See also: [Complete Mathematical Documentation](../docs/proofs/COMPLETE_MATHEMATICAL_DOCUMENTATION.md), the full Tafelwerk*
*See also: [Boundary Navigation](BOUNDARY_NAVIGATION.md), crossing the ¼ boundary*
