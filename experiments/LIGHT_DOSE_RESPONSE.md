...
The [sacrifice geometry](CONCENTRATOR_GEOMETRY.md) protects the SE sector (rate 0.318) by concentrating light away from the cavity's slow standing-wave mode. This is the lens effect quantified per sector.
