...
As decoherence pulls C·Ψ downward from 0.333 toward zero, θ decreases toward 0° — the system approaches the boundary:
...
*See also: [MATHEMATICAL_FINDINGS.md](MATHEMATICAL_FINDINGS.md) — ¼ bound derivation*  
