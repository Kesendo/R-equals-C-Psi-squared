...
- [gamma Control](GAMMA_CONTROL.md): the two-lever noise law; centre concentration +46%, V-shape +6% at matched Σγ (the 21.5× belongs to the combined bridge optimization)
