...
**What stays open, the fence.** Only the γ ~ J edge, where the ballistic caustic observable degenerates and none of these readings is well-posed; every number in this experiment lives at γ ≪ J. The arc's ladder is now closed end to end: the step −δ/(2J), the threshold artifact, the halo mechanism, the ceiling A_∞(γ) = 4 − φ(2J)/γ, the coefficient I₁ in Airy form, the prefactor C(γ), the approach law, and the trichotomy of readings.
