...
| [Seed Existence Reduction](F89_SEED_EXISTENCE_REDUCTION.md) | Proves the all-odd endpoint-nullity surplus N−1. A finite-q defective seed additionally needs a literal count drop and local character; those are certified at N=5,7,9, while the all-odd implication remains open |
