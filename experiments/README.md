...
| [Path-K Diabolic](F89_PATH_K_DIABOLIC.md) | Complete N=5 and N=6 A2 inventories with local character; Tier 2 for the residual integrability mechanism, a conditional twin-scalar restriction supported by finite-N Δ controls. The N=7 A2 inventory and an all-N existence mechanism remain open; the reflection-parity witness constrains real-axis placement |
