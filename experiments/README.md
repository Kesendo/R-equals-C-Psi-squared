...
| [Concentrator Qubit Mapping](CONCENTRATOR_MAPPING.md) | Optimal chain selection on IBM Torino heavy-hex. 330 chains, sacrifice ranking vs mean-T2 ranking: zero overlap in top-10. Sacrifice achieves 2.54x vs 1.18x protection. Worse qubits, better modes. Time-stable over 5 months |
...
| [Concentrator Optics](CONCENTRATOR_OPTICS.md) | The concentrator as entrance pupil / AR coating: Q_max 2-7x, T_eff up, frequencies preserved |
...
| [Absorption Theorem Discovery](ABSORPTION_THEOREM_DISCOVERY.md) | α=2γ⟨n_XY⟩ exact: absorption rate = 2×dephasing×light content. Linear in γ. Proven from L_H anti-Hermitian. Unifies boundary formula, sum rule, spectral gap. 1,342 modes, CV=0 |
