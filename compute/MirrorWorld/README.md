...
number and every dynamics step is pinned from-below by `MirrorWorld.Tests` (213 tests).
...
dotnet test compute/MirrorWorld.Tests                     # the 213-test from-below guard
```
