...
number and every dynamics step is pinned from-below by `MirrorWorld.Tests` (189 tests).
...
dotnet test compute/MirrorWorld.Tests                     # the 189-test from-below guard
```
