...
number and every dynamics step is pinned from-below by `MirrorWorld.Tests` (367 tests).
...
dotnet test compute/MirrorWorld.Tests                     # the 367-test from-below guard
```
