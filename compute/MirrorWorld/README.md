...
number and every dynamics step is pinned from-below by `MirrorWorld.Tests` (366 tests).
...
dotnet test compute/MirrorWorld.Tests                     # the 366-test from-below guard
```
