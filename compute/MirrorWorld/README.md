...
number and every dynamics step is pinned from-below by `MirrorWorld.Tests` (361 tests).
...
dotnet test compute/MirrorWorld.Tests                     # the 361-test from-below guard
```
