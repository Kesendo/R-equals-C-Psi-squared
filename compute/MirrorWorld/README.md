...
number and every dynamics step is pinned from-below by `MirrorWorld.Tests` (294 tests).
...
dotnet test compute/MirrorWorld.Tests                     # the 294-test from-below guard
```
