...
number and every dynamics step is pinned from-below by `MirrorWorld.Tests` (383 tests).
...
dotnet test compute/MirrorWorld.Tests                     # the 383-test from-below guard
```
