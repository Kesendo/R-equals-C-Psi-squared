...
number and every dynamics step is pinned from-below by `MirrorWorld.Tests` (321 tests).
...
dotnet test compute/MirrorWorld.Tests                     # the 321-test from-below guard
```
