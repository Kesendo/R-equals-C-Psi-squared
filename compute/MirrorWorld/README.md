...
number and every dynamics step is pinned from-below by `MirrorWorld.Tests` (169 tests).
...
dotnet test compute/MirrorWorld.Tests                     # the 169-test from-below guard
```
