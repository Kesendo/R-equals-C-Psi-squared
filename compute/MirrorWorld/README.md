...
number and every dynamics step is pinned from-below by `MirrorWorld.Tests` (206 tests).
...
dotnet test compute/MirrorWorld.Tests                     # the 206-test from-below guard
```
