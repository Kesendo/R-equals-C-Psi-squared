...
number and every dynamics step is pinned from-below by `MirrorWorld.Tests` (182 tests).
...
dotnet test compute/MirrorWorld.Tests                     # the 182-test from-below guard
```
