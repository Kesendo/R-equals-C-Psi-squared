...
number and every dynamics step is pinned from-below by `MirrorWorld.Tests` (166 tests).
...
dotnet test compute/MirrorWorld.Tests                     # the 166-test from-below guard
```
...
the closed-form singles F72/F73, F94, F96, F100/F101 (F74 + F77 adopted 2026-07-12) (see "Still outside" above) --
