...
number and every dynamics step is pinned from-below by `MirrorWorld.Tests` (226 tests).
...
dotnet test compute/MirrorWorld.Tests                     # the 226-test from-below guard
```
