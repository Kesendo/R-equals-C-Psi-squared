...
number and every dynamics step is pinned from-below by `MirrorWorld.Tests` (186 tests).
...
dotnet test compute/MirrorWorld.Tests                     # the 186-test from-below guard
```
