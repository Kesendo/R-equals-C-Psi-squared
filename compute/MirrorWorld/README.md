...
number and every dynamics step is pinned from-below by `MirrorWorld.Tests` (219 tests).
...
dotnet test compute/MirrorWorld.Tests                     # the 219-test from-below guard
```
