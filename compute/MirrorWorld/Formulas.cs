...
public static class Formulas
{
    ...
    // X_2j = -M_{n+2j}, the even orders on M_{2j+1}. The gcd gives a sufficient kill route, the
    ...
    // routes to the first unforced rung are named apart because the gcd one has content only at an odd
    ...
    public static int F161_FirstUnforcedOddRungByGcd(int ncomb) => CollisionGap.FirstUnforcedOddRungByGcd(ncomb);
    public static int F161_FirstUnforcedRungByShape() => CollisionGap.FirstUnforcedRungByShape();
