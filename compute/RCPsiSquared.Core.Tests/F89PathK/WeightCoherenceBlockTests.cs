...
/// EVEN under the global bit-flip (zz(b̄) = zz(b)). Thus the identity and its transport of a certified Jordan
/// character are integrability-independent: where Δ splits a diabolic into Jordan EP2s
/// (the finite-N Delta response, certified by XxzCoherenceBlock at the sampled N = 4..7),
/// the partner block splits alike. The discriminant is bit-flip parity: a
