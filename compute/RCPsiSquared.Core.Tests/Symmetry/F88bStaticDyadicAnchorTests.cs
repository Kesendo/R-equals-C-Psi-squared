...
public class F88bStaticDyadicAnchorTests
{
    private readonly ITestOutputHelper _out;

    public F88bStaticDyadicAnchorTests(ITestOutputHelper output) => _out = output;
    ...
    /// mirror config (n_p = 1, n_q = N − 1), F88b's static-fraction lands bit-exactly on the
    ...
    public void Witnesses_StaticFractionMatchesLiveRecomputation()
    {
        ...
        // re-computation at each witness. A divergence here means either the F88b closed
