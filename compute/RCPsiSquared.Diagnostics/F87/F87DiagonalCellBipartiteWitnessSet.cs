...
///
/// <para>Tier: Tier1Candidate, matching the inner witnesses. <c>bipartite ⟹ soft</c> is derived
/// (chiral K); the converse <c>non-bipartite ⟹ hard</c> is derived modulo the first-order-block
/// premise (PROOF_F103 §7.5/§7.6), so the set stays Tier1Candidate pending the formal promotion
/// pass.</para>
///
