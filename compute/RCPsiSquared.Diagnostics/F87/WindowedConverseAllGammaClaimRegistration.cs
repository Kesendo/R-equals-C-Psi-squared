...
/// all-γ theorem, closed 2026-06-10 with no residual: R-deg retired by the girth dichotomy, R-sign
/// resolved by the Pascal-Gram positivity theorem). Two Tier1Derived typed parents:
/// <see cref="F87DiagonalCellBipartiteWitnessSet"/> (the F103 §7 criterion + genericity carrier) and
/// <see cref="WindowedConverseThresholdClaim"/> (the proven Phase B two-reflection spine).
///
...
///
/// <para>Tier consistency: WindowedConverseAllGammaClaim is Tier1Derived ← both parents Tier1Derived
/// (the registry's parent ≥ child rule).</para></summary>
