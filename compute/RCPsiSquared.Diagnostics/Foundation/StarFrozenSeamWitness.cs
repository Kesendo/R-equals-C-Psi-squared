...
public sealed class StarFrozenSeamWitness : IInspectable
{
    ...
    private InspectableNode TheCeilingLadder()
    {
        ...
        return new InspectableNode("the commutant ceiling g2 = 4/(N−1) (the threshold AND the high-Q light content)",
            summary: "the darkest [H,A]=0 commutant (1,1) coherence on the star leaf manifold, recomputed live " +
                     ...
                     "the lone outlier. g2 is also the value the survivor light content saturates at in the high-Q " +
