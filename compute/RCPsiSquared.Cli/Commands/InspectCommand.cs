...
public static class InspectCommand
{
    ...
    public static readonly IReadOnlyList<RootCatalogEntry> Catalog = new RootCatalogEntry[]
    {
        ...
        new("f89galois", "the F89 path-k H_B-mixed Galois groups (k=3..6): Gal(F_d/Q(i)(q)) = S_d for d=8/18/32/53, NON-SOLVABLE ⟹ the decay rates λ_k(q) have no radical closure in q=J/γ. path-3 octic fully live (block → Berkowitz → isolate F_d by dividing out the AT factor → Frobenius S_8); path-4 semi-live (committed F_18 verified to divide the live block charpoly, then S_18). The Galois sibling of the EP-character witness (--root f89octic)",
