...
public static class InspectCommand
{
    ...
    public static readonly IReadOnlyList<RootCatalogEntry> Catalog = new RootCatalogEntry[]
    {
        ...
        new("f89galois", "the F89 path-3 octic Galois group (live Frobenius certificate): Gal(F_8/Q(i)(q)) = S_8, NON-SOLVABLE ⟹ the eigenvalues λ_k(q) have no radical closure in q. Factoring F_8(·,2) mod split primes 𝔭|p (i↦√−1) gives an 8-cycle (transitive) + (5,2,1) at 𝔭|5 (5-cycle ⟹ primitive ⟹ ⊇A_8 by Jordan; odd ⟹ ⊄A_8). The Galois sibling of the EP-character witness (--root f89octic)",
            _ => new F89OcticGaloisWitness(), RequiresN: false),
