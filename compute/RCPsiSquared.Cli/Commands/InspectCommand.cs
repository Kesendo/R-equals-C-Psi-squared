...
public static class InspectCommand
{
    ...
    /// Q_EP pinch [F86a-retraction corrected 2026-07-07, see LocalGlobalEpLink / PROOF_F86A section Correction]. Extra args <c>--g-eff</c> default 4/3, <c>--q-lo</c> default
    ...
    public static readonly IReadOnlyList<RootCatalogEntry> Catalog = new RootCatalogEntry[]
    {
        ...
        new("crosstriple", "the F127/F128/F129/F130 family, live: the F127 GF(p) variety slice + core identity + closed form + sheet lattice, the F128 flip lemma (exact ℤ) + factorization + sharper locus, the F129 exact ℤ[ζ_2n] level-collision census (n ≤ 60), and the F130 exact collision decoupling (every proof cell + controls). Each check carries its own discriminating control; the proof objects stay the 527/527 grid+CRT wall and the committed f12*_* gates. A couple of seconds, fully deterministic",
