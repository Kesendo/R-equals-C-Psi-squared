...
/// chain with Clebsch-Gordan S⁺ transport norms (measured N=5 and N=7, gated in C# and Python; the two η
/// chains inferred from the 4N−8 accounting, untested). One typed parent edge:
///
/// <list type="bullet">
...
/// half (one irreducible chain per anti-diagonal, CG norms at every rung) is measured at two odd N with
/// the N=9 prediction open, so the claim as a whole stays a candidate. Parent Tier 1 derived.</para>
///
