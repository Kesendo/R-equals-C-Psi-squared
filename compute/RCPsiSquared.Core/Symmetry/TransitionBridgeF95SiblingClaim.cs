...
/// siblings: both use the same positive-b angle θ = arctan(√(c/b² − 1)) at a quadratic's discriminant
...
/// TransitionBridge (this, the cusp) and the F86 toy 2x2 EP. The separate Σγ=0
...
public sealed class TransitionBridgeF95SiblingClaim : Claim
{
    ...
    /// <summary>The siblinghood: at and above the EP the clock Rotation angle equals the F95 angle
    /// of the EP's 2-level quadratic; both are exactly zero at the boundary.</summary>
    ...
    protected override IEnumerable<IInspectable> ExtraChildren
    {
        get
        {
            ...
            yield return new InspectableNode("the genuine F86 toy 2x2 EP, b = 4γ₀",
                summary: "F86 2-level in z=−λ: z²−8γ₀z+(12γ₀²+J²g_eff²), double root (EP) at Q_EP=2/g_eff; b=4γ₀>0; above it the F95 angle = the clock Rotation arctan(ω/gap) lifting off. Parameter-space. b=4γ₀ is the ⟨n⟩=2 absorption rung.");
