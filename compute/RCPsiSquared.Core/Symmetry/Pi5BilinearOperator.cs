...
/// from the five Π²_D-even 2-site bilinears under D-dephasing, for any D ∈ {Z, X, Y}.
///
...
///   <item>Y-deph (F108 Part 3): I → +X, X → −I, Y → −iZ, Z → +iY. Same I↔X, Y↔Z
///         permutation as Z-deph (Y-deph and Z-deph share bit_b parity per
///         <see cref="PiOperator.SquaredEigenvalue"/>); differs from Z-deph variant only
///         in the Y/Z 2-cycle phase (−i vs +i), matching the canonical Y-deph Π's phase
///         convention. M² = diag(−1, −1, +1, +1) (same as Z-deph).</item>
/// </list>
///
...
///
/// <para>All three dephase variants supported; full algebraic proofs live in
/// <c>docs/proofs/PROOF_F108_PART1_PI2_EVEN_ALWAYS_PALINDROMIC.md</c>,
/// <c>docs/proofs/PROOF_F108_PART2_PI2X_EVEN_ALWAYS_PALINDROMIC.md</c>, and
/// <c>docs/proofs/PROOF_F108_PART3_PI2Y_EVEN_ALWAYS_PALINDROMIC.md</c>.</para></summary>
public static class Pi5BilinearOperator
{
    /// <summary>Π_5bilinear action on a single Pauli letter for the given dephase
    /// letter D ∈ {Z, X, Y}.</summary>
