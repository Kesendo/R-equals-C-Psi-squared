...
/// <summary>F88b popcount-coherence Π²-odd / memory closed form, exposed as a typed Claim
...
/// inherits from <see cref="KleinFourCellClaim"/> (F88a's 4-cell Π² decomposition), at the
...
public sealed class PopcountCoherenceClaim : Claim
{
    public PopcountCoherenceClaim()
        : base("F88b popcount-coherence Π²-odd / memory closed form (operator + state inheritance)",
               Tier.Tier1Derived,
               "docs/ANALYTICAL_FORMULAS.md F88a + F88b + docs/proofs/PROOF_F86B_UNIVERSAL_SHAPE.md §F88b + compute/RCPsiSquared.Core/Symmetry/PopcountCoherencePi2Odd.cs")
    { }

    public override string DisplayName =>
        "F88b popcount-coherence (operator + state Π²-odd inheritance)";
    ...
    protected override IEnumerable<IInspectable> ExtraChildren
    {
        get
        {
            ...
            yield return new InspectableNode("operator parent",
                summary: "KleinFourCellClaim: F88a 4-cell Π² decomposition is the operator-level root");
