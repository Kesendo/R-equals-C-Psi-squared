...
/// <c>simulations/f86_doubled_ptf_bare_floor_derivation.py</c>) to two regime-specific
/// closed forms:</para>
///
/// <code>
///   Post-EP (x > 1, ξ = √(x²-1)):
...
/// <c>simulations/f86_doubled_ptf_bare_floor_derivation.py</c> (sympy derivation +
