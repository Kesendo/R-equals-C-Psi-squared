...
| `YParityIndependenceAtK3` (Symmetry/) | **F102**: y_par = (#Y mod 2) is a term-level Z₂ classifier; collapses to bit_a XOR bit_b at k_body=2 (every Pauli bilinear), independent of Klein at k_body≥3. The YParity axis on `PolarityCubeMap`. Tier 1 derived |
