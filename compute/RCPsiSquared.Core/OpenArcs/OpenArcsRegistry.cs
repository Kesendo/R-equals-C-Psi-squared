    ...
    private static readonly IReadOnlyList<OpenArc> _all = new[]
    {
        ...
        new OpenArc(
            ...
            RetiredReason: "RESOLVED 2026-06-20: M4 LANDED (the last milestone), completing M0-M4 of the " +
                ...
                "by a gate-first decider (simulations/_handshake_m4_second_law_decider.py): MM(0) is BLIND to " +
                ...
                "0.2%. Verifier simulations/_handshake_closure_paritycheck.py (G1 plateau even-N->1bit + odd-N " +
