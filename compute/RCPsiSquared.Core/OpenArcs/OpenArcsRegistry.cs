    ...
    private static readonly IReadOnlyList<OpenArc> _all = new[]
    {
        ...
        new OpenArc(
            ...
            NextStep: "RESUMPTION POINT (2026-08-02, end of session). FOUR THINGS ARE DONE and are not to be " +
                ...
                + "(7) OPEN AND ODD: at every N a cusp sits at a NEGATIVE rate near -0.187 (-0.18785 at N=5, -0.18693 at N=6, -0.18717 at N=7), across different profiles, which is the gain side and therefore GammaFold territory. Not chased yet. "
                + "WHAT IS OWED BEFORE ANY OF (1)-(7) IS CITED ELSEWHERE: a committed gate, and the usual empty-session rounds. The repo holds no counting law of this shape anywhere (a counting law for the real exceptional couplings is an open item on the F140/F143 list), so this is new surface and must not be leaned on until it has been attacked. " +
