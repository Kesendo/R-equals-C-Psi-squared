...
**What F113 did not cover**, and this document originally read as settled: an anti-Hermitian part B outside the per-site n = (I−Z)/2 family. That gap was closed on 2026-08-19 by [F155](../docs/proofs/PROOF_F155_PHYSICAL_GENERATOR_POLARITY_BREAK.md), which gives the general law for H = A + iB, derived and universal N, and has F113 as its Z-diagonal special case. The drain result below is one of its two self-terms.
...
| drain term alone, −½{c†c, ·} | ANY collapse operator | 0 | DERIVED 2026-08-19 (F155 Step 4: the self-term is real, so its imaginary part, which is the asymmetry, is zero) |
