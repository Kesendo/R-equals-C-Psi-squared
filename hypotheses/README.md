...
- [Gamma Is Light](GAMMA_IS_LIGHT.md) - If the qubit chain is a Fabry-Perot (proven) and gamma must be external (proven), then gamma plays the role of light. Mass is trapped light. Black holes are perfect cavities. The bounce happens at CΨ = 1/4. Tier 4 (structural hypothesis from proven optical analogy, April 3, 2026).
