...
- [Fragile Bridge](FRAGILE_BRIDGE.md) - Coupled gain-loss systems have a finite stability window; instability is Hopf bifurcation (not PT breaking); N-dependence non-monotonic (even N more stable). Neural sigmoid provides biological safety mechanism. Tier 2 (three independent scripts, cross-level test).
