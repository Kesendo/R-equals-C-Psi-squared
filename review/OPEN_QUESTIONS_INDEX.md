...
**Total entries:** 327
**Status:** Partially triaged 2026-06-04 (see the Triage section below): ~20 resolved, 5 stale/retired/falsified, ~165 scrape artifacts (non-questions), ~137 genuinely open. Full re-classification still pending; the individual per-entry `Status:` fields below are NOT yet updated, the Triage section is the live view.
...
This raw inventory was never classified. A 2026-06-04 agent pass triaged it; each "resolved" was
verified against its source doc. This section is the live view; the per-entry `Status:` fields
...
~165 entries are section headers, data rows, answer fragments, or scope qualifiers, not questions
...
neural / cross-substrate exploratory questions (OQ-064..071, open-exploratory, not answered). Only
these earn the "open" stamp.
